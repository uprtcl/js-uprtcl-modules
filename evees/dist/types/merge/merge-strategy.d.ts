...
export interface MergeStrategy {
     ...
     */
    mergeCommits(toCommitId: string, fromCommitId: string, dataSource: string, workspace: EveesWorkspace, config: any): Promise<string>;
    /**
     * Merges the links to other entities appropiately
     * @returns the new list of links
     */
    mergeLinks(originalLinks: string[], modificationsLinks: string[][], workspace: EveesWorkspace, config: any): Promise<any[]>;
}
