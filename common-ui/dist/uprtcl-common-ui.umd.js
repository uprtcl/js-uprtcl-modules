(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('reflect-metadata'), require('@uprtcl/micro-orchestrator'), require('lit-element')) :
    typeof define === 'function' && define.amd ? define(['exports', 'reflect-metadata', '@uprtcl/micro-orchestrator', 'lit-element'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['uprtcl-common-ui'] = {}, null, global.microOrchestrator, global.litElement));
}(this, (function (exports, reflectMetadata, microOrchestrator, litElement) { 'use strict';
...
`;
  ...
  `,
        hourglass_empty: litElement.html `
    <svg
  ...
  `,
        arrow_forward: litElement.html `
    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
      <path d="M0 0h24v24H0z" fill="none" />
      <path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z" />
    </svg>
  `,
        arrow_upward: litElement.html `
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="black"
  ...
  `,
        arrow_downward: litElement.html `
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="black"
  ...
  `,
        add_circle_outline: litElement.html `
    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
      <path d="M0 0h24v24H0z" fill="none" />
      <path
  ...
  `,
        done: litElement.html `
    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
      <path d="M0 0h24v24H0z" fill="none" />
      <path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" />
    </svg>
  `,
        menu: litElement.html `
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="black"
  ...
  `
    ...
    class UprtclButton extends litElement.LitElement {
        constructor() {
            super(...arguments);
    ...
    class UprtclLoading extends litElement.LitElement {
        render() {
            return litElement.html `
    ...
    class UprtclList extends litElement.LitElement {
        render() {
            return litElement.html `<slot></slot>`;
        }
        static get styles() {
            return [styles, litElement.css ``];
        }
    }

    class UprtclListItem extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.selected = false;
            this.hasMeta = false;
    ...
    class UprtclCard extends litElement.LitElement {
        render() {
            return litElement.html `<slot></slot>`;
        }
        static get styles() {
    ...
    class UprtclButtonLoading extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.loading = false;
            this.outlined = false;
    ...
    class UprtclPopper extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.logger = new microOrchestrator.Logger('UPRTCL-POPPER');
            this.icon = 'more_vert';
    ...
    __decorate([
        litElement.property({ type: Boolean, attribute: 'disable-dropdown' }),
        __metadata("design:type", Boolean)
    ...
    class UprtclOptionsMenu extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.config = {};
            this.icon = 'more_vert';
    ...
    class UprtclHelp extends litElement.LitElement {
        render() {
            return litElement.html `
    ...
    class UprtclFormString extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.fieldValue = '';
    ...
    __decorate([
        litElement.property({ type: String, attribute: 'value' }),
        __metadata("design:type", String)
    ], UprtclFormString.prototype, "fieldValue", void 0);
    __decorate([
        litElement.property({ type: String, attribute: 'label' }),
        __metadata("design:type", String)
    ], UprtclFormString.prototype, "fieldLabel", void 0);
    __decorate([
        litElement.property({ type: String, attribute: 'cancel-icon' }),
        __metadata("design:type", String)
    ], UprtclFormString.prototype, "cancelIcon", void 0);
    __decorate([
        litElement.property({ type: String, attribute: 'accept-icon' }),
        __metadata("design:type", String)
    ...
    __decorate([
        litElement.query('#text-input'),
        __metadata("design:type", Object)
    ], UprtclFormString.prototype, "newTitleEl", void 0);

    class UprtclListItemWithOption extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.text = '';
            this.selected = 'false';
    ...
    class UprtclIconButton extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.button = false;
            this.skinny = false;
    ...
    class UprtclTextField extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.label = 'label';
            this.value = '';
        ...
        render() {
            return litElement.html `<div class="container">
      ${this.focused ? litElement.html `<div class="label">${this.label}</div>` : ''}
    ...
    __decorate([
        litElement.query('#input-element'),
        __metadata("design:type", HTMLInputElement)
    ], UprtclTextField.prototype, "inputEl", void 0);

    class UprtclSelect extends litElement.LitElement {
        render() {
            return litElement.html `<select
      ><slot></slot
    ></select>`;
        }
        static get styles() {
    ...
    class UprtclToggle extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.disabled = false;
            this.active = false;
    ...
    <div class="toggle-container ${this.disabled ? 'disabled' : ''}">
      ${this.icon !== undefined
            ? litElement.html `<div class="icon-container">${icons[this.icon]}</div>`
            : ''}
      <slot></slot>
      <div
    ...
    class UprtclIndicator extends litElement.LitElement {
        constructor() {
            super(...arguments);
            this.label = '';
            this.value = '';
    ...
    class CommonUIModule extends microOrchestrator.MicroModule {
        constructor() {
            super(...arguments);
            this.logger = new microOrchestrator.Logger('COMMON-UI-MODULE');
        }
        async onLoad() {
    ...
    exports.CommonUIBindings = CommonUIBindings;
    exports.CommonUIModule = CommonUIModule;
    exports.UprtclButton = UprtclButton;
    exports.UprtclButtonLoading = UprtclButtonLoading;
    exports.UprtclCard = UprtclCard;
    exports.UprtclDialog = UprtclDialog;
    exports.UprtclFormString = UprtclFormString;
    exports.UprtclHelp = UprtclHelp;
    exports.UprtclIconButton = UprtclIconButton;
    exports.UprtclList = UprtclList;
    exports.UprtclListItem = UprtclListItem;
    exports.UprtclListItemWithOption = UprtclListItemWithOption;
    exports.UprtclLoading = UprtclLoading;
    exports.UprtclOptionsMenu = UprtclOptionsMenu;
    exports.UprtclPopper = UprtclPopper;
    exports.UprtclSelect = UprtclSelect;
    exports.UprtclTextField = UprtclTextField;
    exports.icons = icons;
...
//# sourceMappingURL=uprtcl-common-ui.umd.js.map
